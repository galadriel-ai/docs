...
### Run a GPU node on command line
...
<Steps>
    ...
    * Set `ORACLE_ADDRESS` to the [current devnet oracle address](/oracle-address) provided by Galadriel team:
...
* Continue developing your own contracts. See the [contracts readme](https://github.com/galadriel-ai/contracts/tree/main/contracts) and the [Solidity reference](/reference) for more.
