...
- **Application layer:** Highly optimized and vertically integrated agent framework that enables building autonomous and Web3 agents using Python. The framework is a fork of smol-agents, a state-of-the-art agent framework.
