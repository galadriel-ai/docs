...
💡 [Dexscreener](https://dexscreener.com/) is a widely used Web3 tool to monitor crypto market data like prices, new tokens, etc. Galadriel offers it out of the box as a tool to enable an agent to fetch market data across multiple chains.
