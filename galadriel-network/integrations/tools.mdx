...
Check out [Agentic RAG [in review 👀]](https://www.notion.so/Agentic-RAG-in-review-19652f74d7f68012bfebd70158c6315e?pvs=21) where `RetrieverTool` is used to build an agent that leverages a knowledge base.
