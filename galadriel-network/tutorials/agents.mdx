...
2. [**Tools**](https://docs.galadriel.com/galadriel-network/tutorials/tools) it can call (e.g., a web search tool, a database query tool),
3. [**Memory**](https://docs.galadriel.com/galadriel-network/tutorials/memory) for context,
4. [**Input/Output Clients**](https://docs.galadriel.com/galadriel-network/tutorials/clients) that send user queries and receive responses,
5. **A [Runtime](https://docs.galadriel.com/galadriel-network/concepts/runtime)** that orchestrates continuous execution, communication and state persistence.
...
- Utilize state-of-the-art LLM [Models](https://docs.galadriel.com/galadriel-network/integrations/models).
- Integrate seamlessly with [Tools](https://docs.galadriel.com/galadriel-network/tutorials/tools).
- Maintain meaningful [Memory](https://docs.galadriel.com/galadriel-network/tutorials/memory).
- Run continuously, responding to user requests in real time when combined with an [AgentRuntime](https://docs.galadriel.com/galadriel-network/concepts/runtime).

---

## Next Steps

- Learn how to integrate your agent into the [AgentRuntime](https://docs.galadriel.com/galadriel-network/concepts/runtime).
- [Examples](https://docs.galadriel.com/galadriel-network/examples/examples) - Check out our repository for real-world sample projects.