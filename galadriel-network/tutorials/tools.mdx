...
Visit the [Tools Integration](https://docs.galadriel.com/galadriel-network/integrations/tools) page to explore our growing list of supported tools and learn how to integrate them. You can also leverage tools from [Composio](https://composio.dev/) and [Langchain](https://python.langchain.com/v0.1/docs/modules/tools/).
...
- [Tools](https://docs.galadriel.com/galadriel-network/integrations/tools)
- [Wallet](https://docs.galadriel.com/galadriel-network/concepts/wallet)
- [Memory](https://docs.galadriel.com/galadriel-network/tutorials/memory)
