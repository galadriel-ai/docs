...
description: Galadriel Verified Inference API provides LLM inferences results that are signed by the TEE private key add attested by AWS enclave. This page gives overview on how to verify the attestation.
---
