...
These two methods in combination are used to provide the oracle with the message history necessary for the LLM call. They are called by the oracle after you invoke [`createLlmcall`](/reference/llms/basic#createllmcall) or an analogous method for other LLM providers.
