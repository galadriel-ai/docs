...
```
<Info>
If you don't have the `IOracle.sol`locally, you can also import it via GitHub like this: `import "https://github.com/galadriel-ai/contracts/blob/main/contracts/contracts/interfaces/IOracle.sol";`
</Info>
### Variables
