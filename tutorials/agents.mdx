...
<Tip>
    Try out and see the agent in action using the [script](https://github.com/galadriel-ai/contracts/blob/main/examples/agent.ts) that calls already deployed contract.
