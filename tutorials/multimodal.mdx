...
8. Swap out the whole `startChat` function to the following. This starts the LLM call with a list of image URLs and text input.
In addition to `https` and base64-encoded image `data` URLs, the Oracle supports `ipfs://` URLs too.
